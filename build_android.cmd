set ANDROID_NDK_HOME=D:/sdkroot/ndk/24.0.8215888
set CURRENT_DIR=%~dp0
...
go build -buildmode=c-shared -ldflags="-w -s" -trimpath -v -x -o output/android/armeabi-v7a/libAXPBEncJNI.so
...
go build -buildmode=c-shared -ldflags="-w -s" -trimpath -v -x -o output/android/arm64-v8a/libAXPBEncJNI.so
